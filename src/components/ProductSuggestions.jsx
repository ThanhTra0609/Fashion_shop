...
function ProductSuggestions({ suggestions }) {
  return (
    <div className="mt-5 mb-5">
      ...
      <div id="suggestionsCarousel" className="carousel slide" data-bs-ride="carousel">
            ...
            <div key={item.id} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
              <div className="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div className="card-body text-center">
                  ...
                  <a href={`/product/${item.id}`} className="btn rounded-pill px-4" style={{ backgroundColor: '#ff69b4', color: 'white' }}>
                    Xem chi tiết
                  </a>
                </div>
              </div>
        ...
        <button className="carousel-control-prev" type="button" data-bs-target="#suggestionsCarousel" data-bs-slide="prev">
        ...
        <button className="carousel-control-next" type="button" data-bs-target="#suggestionsCarousel" data-bs-slide="next">
